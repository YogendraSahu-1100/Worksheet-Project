            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                <div className="flex items-center">
                  <input id="remember-me" name="remember-me" type="checkbox" onClick={() => {setShwpassword((prev) => !prev);}} className="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-white-300 rounded" />
